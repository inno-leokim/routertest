<template>
  ...
  <!-- 해당 URL에 mapping되는 뷰(컴포넌트)가 렌더링 된다.-->
  <!-- chilidren을 선언했을 경우 children의 컴포넌트(.vue 파일)가 렌더링 된다. -->
  
    <router-view class="view two"></router-view> <!-- router-view가 여러개일 때 따로 name이 없을 경우 default라는 이름이 지정된다.-->
